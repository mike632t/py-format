...
_types = ['.a68', '.ada', '.bas', '.c', '.cmd', '.cob', '.dcl', '.f77',
  '.for', '.ftn', '.h', '.json', '.pas', '.py', '.ps1', '.rs', '.sh', '.vbs',
  '']
...
_keywords =  { # Keyword Tokens
  ...
  '.py': ['and', 'as', 'assert', 'break', 'class', 'continue','def', 'del',
    'elif', 'else', 'except', 'exec', 'fiencode("utf-8")nally', 'for', 'from', 'global',
  ...
  '.vbs':['And', 'As', 'Boolean', 'ByRef', 'Byte','ByVal', 'Call', 'Case',
    ...
    'Exit', 'For', 'Function', 'Get', 'GoTo', 'If', 'Imp', 'Implements', 
    'In', 'Integer', 'Is', 'Let', 'Like', 'Long', 'Loop', 'LSet', 'Me', 
    'Mod', 'New', 'Next', 'Not', 'Nothing', 'Null', 'On', 'Option', 
    'Optional', 'Or', 'ParamArray', 'Preserve', 'Private', 'Public', 
    'RaiseEvent', 'ReDim', 'Rem', 'Resume', 'RSet', 'Select', 'Set', 
    'Shared', 'Single', 'Static', 'Stop', 'Sub', 'Then', 'To', 'Type', 
